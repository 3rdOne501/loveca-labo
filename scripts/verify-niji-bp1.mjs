...
const CASES = [
  ...
  { id: "PL!N-bp1-005-R", trigger: "live_start", expectTemplate: "grant_jouji_session", check: (cl) => (cl.handDiscardToWaiting === 1 ? [] : ["handDiscardToWaiting"]) },
  ...
  { id: "PL!N-bp1-026-L", trigger: "live_success", expectTemplate: "yell_resolution_pick_hand" },
  {
    id: "PL!N-bp1-027-L",
    trigger: "live_start",
  ...
  },
  {
    ...
    check: (cl) => (cl.cardScoreGrant === 1 && cl.filters?.minStageSeriesMembers === 1 ? [] : ["score/filters"]),
  },
  {
    id: "PL!N-bp1-029-L",
    trigger: "live_start",
