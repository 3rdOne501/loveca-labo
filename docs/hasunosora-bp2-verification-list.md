...
| [x] | 005 | PL!HS-bp2-005-P | 大沢瑠璃乃 | toujou_wait_pick_hand / optional_energy_blade_until_live_end | 登場 手札捨て任意→他メンバーいればみらくらぱーく1枚回収 / ライブ開始 E任意→全エリア埋まりでブレード2 |
| [x] | 006 | PL!HS-bp2-006-P | 藤島慈 | toujou_optional_all_members_relocate / jouji passive | 登場: 全メンバー任意移動 / 常時: 他みらくらぱーく1人につきブレード1 |
| [x] | 007 | PL!HS-bp2-007-P | 百生吟子 | toujou_wait_pick_hand / grant_jouji_session | 登場: 低コストスリーズブーケからバトン→蓮ノ空ライブ1枚 / ライブ開始 手札捨て→同名メンバーにheart04+ブレード |
...
| [x] | 014 | PL!HS-bp2-014-N | 大沢瑠璃乃 | draw_from_deck | 1ドロー→**ライブ終了までライブ不可** |
...
| [x] | 017 | PL!HS-bp2-017-N | 徒町小鈴 | draw_from_deck | 控え室10枚+なら1ドロー |
...
| [x] | 026 | PL!HS-bp2-026-L | みらくりえーしょん | live_card_score_plus | ライブ開始: 右瑠璃乃・左姫芽・中慈→スコア+2 |

## 2026-06-28 検証

全26枚（能力あり）の分類監査: **guided_manual=0**。新規コード修正なし。
