...
## 2026-06-30 2回監修（Liella! sd1 DUO 収録カード群）

**対象**: メンバー 001–022（能力付き 14 枚 + 能力なし 8 枚）、ライブ 023–026（能力付き 1 枚 + リマインダー 3 枚）。エネルギー 027–037 は対象外。

- verify 14 / audit 通過
- 023–025 は `special_heart` リマインダー（トリガー能力なし）
...
001–011, 014, 016–017, 026 および能力なし 010, 012–013, 015, 018–022、リマインダー 023–025
