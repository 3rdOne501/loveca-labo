...
## 2026-06-30 2回監修（蓮ノ空 sd1 収録カード群）

**対象**: メンバー 001–016（能力付き 11 枚 + 能力なし 5 枚）、ライブ 017–020（能力付き 3 枚 + 能力なし 1 枚）。エネルギー P カードは対象外。

- verify 15 / audit 通過
- 004/005 の常時（指名キャラ条件）は `jouji` 側 `blade_if_character_on_stage` で処理
...
001–006, 008–009, 013–018, 020 および能力なし 007, 010–012, 016, 019
