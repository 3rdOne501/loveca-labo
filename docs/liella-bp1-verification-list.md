...
| ID | 内容 |
|----|------|
| （全体） | メンバー分類・ハンドラ OK。verify 15ケース（001 jouji / 009 kidou 追加） |

## 2026-06-30 再監修（2回目・ライブ 023–027）

| ID | 内容 |
|----|------|
| （全体） | 分類・ハンドラ OK。実行時バグなし。verify 16ケース |
| PL!SP-bp1-023-L | `live_score_higher_energy_wait` + ソロ相手スコア0扱い（FAQ Q66）— 2026-06-28 修正済を再確認 |
| PL!SP-bp1-024-L | `playBonusHeartSlotsAlways` 指名ハート+ブレード / LS成功かのん+可可在席で1ドロー |
| PL!SP-bp1-026-L | ステージ+控え室異名Liella!5人→必要ハート桃2/黄2/紫2固定 |
