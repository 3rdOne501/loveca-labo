...
| ID | 内容 |
|----|------|
| PL!N-bp5-011-P | `ability_pick_one`: 異名ライブ3+/異グループ3+ 前提未チェック・2枚回収未実装 → `abilityChoiceTextPreconditionMet` + 2枚ピック |
| PL!N-bp5-014-N | `kidou_hand_cost_wait_pick_hand`: E2 コスト未支払い → ハンドラ先頭で `payAbilityCost`（Liella/Aqours 同型横展開） |

### 問題なし（3回目再確認）

001 jidou BH ティア、002 最多ハート、003 起動スコア支払、004 ちょうど4BL、005 バトンBH、006 自アクティブ不可/LSウェイト、007 SL同数ブレード+余剰ドロー、008 E活性、009 必須ウェイト+山札5、010 余剰スコア、012 E下+ドロー/LS Eウェイト、013 E下前提、015 全6色、016/019/021/022/023 各分類 OK。
